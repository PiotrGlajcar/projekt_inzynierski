...
function ManageCourse() {
  ...
  return (
    <div className="manage-course">
            ...
            <div className="edit-scores" ref={editFormRef}>
              ...
              >
                ...
                {selectedCourse.assignments.map((assignment, index) => {
                  const currentGrade = editingScores.find(
                    (score) => score.assignment_id === assignment.id
                  )?.score || "Brak oceny";
                  return (
      ...
      {/* Confirmation Modal for Deleting Participants */}
      <ConfirmationModal
        isOpen={isDeleteModalOpen}
        onConfirm={() => handleRemoveParticipant(studentToDelete)}
        onCancel={() => {
          setIsDeleteModalOpen(false);
          setStudentToDelete(null);
        }}
        message="Czy na pewno chcesz usunąć tego uczestnika z kursu?"
      />
    </div>
  );
}
