...
zapoznać uczestników z działaniem oprogramowania na zajęciach organizacyjnych,
aby zapewnić im dostęp do własnych kont, na których dokumentowane będą ich
indywidualne postępy.</p>
            </div>
        </div>
    );
}
